...
namespace BASE
{
    ...
    inline mTimestamp addTime(mTimestamp t,double seconds){
        int64_t adder=static_cast<int64_t>(seconds*1000*1000);
        return t.getMicrosecond()+adder;
    }
} // namespace TMS